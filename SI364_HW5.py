...
app.config["SQLALCHEMY_DATABASE_URI"] = "postgresql://localhost/jgroppsHW5"
...
app.config['MAIL_USERNAME'] = 'jonnygropper22@gmail.com' 
app.config['MAIL_PASSWORD'] = "ilovepython"
app.config['MAIL_SUBJECT_PREFIX'] = '[jgroppshw5]'
app.config['MAIL_SENDER'] = 'jonnygropper22@gmail.com' 
app.config['ADMIN'] = 'jonnygropper22@gmail.com' 
...
class TweetForm(FlaskForm):
    ...
    email = StringField("What is the email you associate with your twitter?",validators=[Required()])
